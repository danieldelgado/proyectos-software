...
<body>
<form id="formContenido" method="post"	action="<c:url value="/Proyecto/${proyecto.folder}/${proyecto.id}/guardarContenido/${seccionDocumento.id}" ></c:url>">

<div>
<p> <label> Ruta de la Seccion : </label>  <label>${seccionDocumento.ruta_Seccion}</label> </p>
<p> <label> Titulo : </label>  <label> <input type="text" name="titulo" value="Introduccion" > </label> </p>
<p> <label> Nombre : </label>  <label> <input type="text" name="nombre" value="Introduccion" > </label> </p>
<p> <label> Descripcion : </label>  <label> <input type="text" name="descripcion" value="describiendo" > </label> </p>
 <input type="hidden" name="seccionDocumento.id" value="${seccionDocumento.id}" >
</div>
<div>
	<textarea name="content_html" class="tinymce">
	</textarea>
</div>
</form>
</body>
