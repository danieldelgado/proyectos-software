...
public class GCMBroadcast extends HttpServlet {
	...
	private static final String SENDER_ID = "AIzaSyAEe5XM-fTRyjXE-A-IBjrupvudjqFKdX0";
	
	// This is a *cheat*  It is a hard-coded registration ID from an Android device
	// that registered itself with GCM using the same project id shown above.
	private static final String ANDROID_DEVICE = "APA91bGLcUJkUSu6p-AUugnap7Xyv4wEgg1pukjDTgynUtbVD1ZtM5XaQRP0WpPc96j03LwXncYFyZIZGHFHB7m8ju3hWm_Xbc76VbjnVN17wsa7ZI6G5drw-TbopQFo4IuO0qd05Y1ZAO419eEBZXdAskrLr2hKfpuIpNdixXVuFDIyL2BfKsA";
