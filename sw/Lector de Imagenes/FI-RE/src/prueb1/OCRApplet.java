...
public class OCRApplet extends Applet {
	...
	public static final String HANDWRITING[] = { "A:00110001100111001010111111100110001", "B:11111100011000111111100111000110111",
			"C:11111100001000010000100001100001111", "D:11111100011000110000100011000111111", "E:11111100001000011111100001000011111",
			"F:11111100001000011110100001000010000", "G:01110110001000010111100011000111111", "H:10001100001000111001111111000110001",
			"I:11111001000010000100001000010000111", "J:11111001000010000100101001010011100", "K:10001100111111011010100101001110011",
			"L:10000100001000010000100001000011111", "M:11111101111011110100101001010110101", "N:11111110111000110001100001000110001",
			"O:11111100011000110000100011000111111", "P:11111100011001111110100001000010000", "Q:01111110011000110001100111101101111",
			"R:11111100011000111011111101001110001", "S:01111110001100001111000010000111111", "T:11111001000010000100001000010000100",
			"U:10001100001000110001100011001111110", "V:10001100011101101011011100111000110", "W:10101101011010110101101011011111111",
			"X:10011110100111001100111001011010010", "Y:10001110110111001100010000100001000", "Z:11111000110011001100110001000011111", };
	...
	public void init() {
		...
		topPanel.add(message = new Label("Draw a capital letter, click Recognize"), BorderLayout.NORTH);
	...
	void train_actionPerformed(java.awt.event.ActionEvent event) {
		...
		try {
			int inputNeuron = OCRApplet.DOWNSAMPLE_HEIGHT * OCRApplet.DOWNSAMPLE_WIDTH;
	...
	public void preload() {
		...
		for (int i = 0; i < OCRApplet.HANDWRITING.length; i++) {
			...
			SampleData ds = new SampleData(line.charAt(0), OCRApplet.DOWNSAMPLE_WIDTH, OCRApplet.DOWNSAMPLE_HEIGHT);
