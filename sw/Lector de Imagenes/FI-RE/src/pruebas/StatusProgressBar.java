...
public class StatusProgressBar extends JPanel {
	...
	/**
	 * Sets the progress cycle time in milliseconds. Default value is 3000 (3 seconds). This value
	 * should be a multiple of the repaint interval.
	 * 
	...
	/**
	 * Sets the repaint interval for the progress bar in milliseconds. The default value is 50ms.
	 * 
	...
	/**
	 * Sets the string to be painted over top of the progress bar. If the string is empty or null
	 * the progress string is removed.
	 * 
