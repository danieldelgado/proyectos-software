...
public class DocumentScanner {
	...
	public final void scan(PixelImage pixelImage, DocumentScannerListener listener, int blockX1, int blockY1, int blockX2, int blockY2) {
		 ...
		 * ///System.out.println("right blackCount="
		 * +blackCount+" maxBlack="+maxBlack
		 * +" blockY1="+blockY1+" blockY2="+blockY2); if (blackCount >=
		 ...
		 * blockX1; x <= blockX2; x++, idx++) { if (pixels[idx] < thresh)
		 * blackCount++; }
		 * ///System.out.println("bottom blackCount="+blackCount+
		 * " maxBlack="+maxBlack+" blockX1="+blockX1+" blockX2="+blockX2); if
		 * (blackCount >= maxBlack) {
		 * ///System.out.println("    reduce bottom"); reduced = true;
		 * blockY2--; if (blockY1 >= blockY2) break; } }
		 * 
