...
package pruebas.net.sourceforge.javaocr.scanner;
...
public class PixelImage {
	...
	protected static final float[] FILTER_FIR_COEFFS = { 0.05001757311983922f, -0.06430830829693616f, -0.0900316316157106f, 0.1500527193595177f,
			0.45015815807855303f, 0.45015815807855303f, 0.1500527193595177f, -0.0900316316157106f, -0.06430830829693616f, 0.05001757311983922f, };
	/**
	...
	public PixelImage(Image image) {
		try {
			Thread.sleep(5000);
			BufferedImage a = new BufferedImage(image.getWidth(null), image.getHeight(null), BufferedImage.TYPE_3BYTE_BGR);
			a.getGraphics().drawImage(image, 0, 0, null);
			ImageIO.write(a, "jpg", new File("/home/daniel/Documentos/archivosprueba/modificado/wdwddqwd345345" + ".png"));
		} catch (Exception e) {
		...
		try {
			...
			BufferedImage a = new BufferedImage(image.getWidth(null), image.getHeight(null), BufferedImage.TYPE_3BYTE_BGR);
			a.getGraphics().drawImage(image, 0, 0, null);
			ImageIO.write(a, "jpg", new File("/home/daniel/Documentos/archivosprueba/modificado/wdwddqwd345436" + ".png"));
		} catch (Exception e) {
			System.out.println(e);
		}
