...
//public class PanelNorte2 extends CustomPanel {
//
...
//	
//	private final static Logger _log = Logger.getLogger(PanelNorte2.class.getName()); 
//	
//	public PanelNorte2(Principal principal) {
...
//		_log.info("procesabado carga en memoria de archivo al "+progressBar.getValue());
//		if (task.isStart()) {
