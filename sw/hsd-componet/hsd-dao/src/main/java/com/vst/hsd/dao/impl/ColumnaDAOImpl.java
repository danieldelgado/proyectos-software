...
public class ColumnaDAOImpl extends DAO<Columna> implements ColumnaDAO {
	...
	public List<Columna> buscarPorLista(Integer id) {
		sqlQuery = "select  new Columna(c.id, c.addColumn, c.ancho, c.atributo, c.cabecera, c.codigo, c.tabla,  c.alineacion, c.formato_tipo, c.mapping,c.visible, c.orden, c.estado, c.activo)  from Lista ls join  ls.columnas c where ls.id = :lista";
