...
public class AsignableTag extends SimpleTagSupport{
	 ...
	 *
	 * @param disponibles the new disponibles
	 */
	 ...
	 * Sets the asignados.
	 *
	 * @param asignados the new asignados
	 */
	 ...
	 *
	 * @param nombreInput the new nombre input
	 */
	 ...
	 *
	 * @param funcionAsignar the new funcion asignar
	 */
	 ...
	 *
	 * @param funcionNoAsignar the new funcion no asignar
	 */
