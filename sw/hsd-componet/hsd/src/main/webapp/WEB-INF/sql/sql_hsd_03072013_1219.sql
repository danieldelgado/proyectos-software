...
--
-- Host: 192.168.1.37    Database: hsd
-- ------------------------------------------------------
...
INSERT INTO `boton` VALUES (1,NULL,NULL,NULL,NULL,1,NULL,'nuevo','mantenimiento/registrarParametro/Formulario_Parametro',3,'Nuevo'),(1,NULL,NULL,NULL,NULL,1,NULL,'formulario','mantenimiento/guardarParametro',4,'Grabar');
/*!40000 ALTER TABLE `boton` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `boton_por_formulario`
--
...
LOCK TABLES `boton_por_formulario` WRITE;
/*!40000 ALTER TABLE `boton_por_formulario` DISABLE KEYS */;
INSERT INTO `boton_por_formulario` VALUES (16,4);
...
INSERT INTO `boton_por_menu` VALUES (2,3);
...
INSERT INTO `columna` VALUES (1,1,1,NULL,0,'id',NULL,'wefewfwf',NULL,NULL,NULL,'wefwe',1,1,'Parametro',0),(2,1,1,NULL,100,'codigo','Codigo','wefewf',NULL,NULL,NULL,'wefwefgeytjty',1,2,'Parametro',1),(3,1,1,NULL,100,'activo','Activo','gghrttr3ewf',NULL,NULL,NULL,'fwefweegweg',1,3,'Parametro',1),(4,1,1,NULL,100,'descripcion','Descripcion','gghrttr3ewf45',NULL,NULL,NULL,'wefew',1,4,'Parametro',1),(5,1,1,NULL,100,'valor','Valor','gghrttr3ewf455634',NULL,NULL,NULL,'fwewefew',1,5,'Parametro',1),(6,1,1,NULL,0,'id',NULL,'weffewfef',NULL,NULL,NULL,'qwdwqd',1,1,'Perfil',0),(7,1,1,NULL,100,'codigo','Codigo','wfweewht2',NULL,NULL,NULL,'ewfewfefew',1,2,'Perfil',1),(8,1,1,NULL,100,'descripcion','Descripcion','wefewfwf',NULL,NULL,NULL,'wefwe',1,3,'Perfil',1),(9,1,1,NULL,100,'estado','Estado','wefewf',NULL,NULL,NULL,'wefwefgeytjty',1,4,'Perfil',1),(10,1,1,NULL,100,'nombre','Nombre','gghrttr3ewf',NULL,NULL,NULL,'fwefweegweg',1,5,'Perfil',1),(11,1,1,NULL,0,'id',NULL,'fewwe',NULL,NULL,NULL,'wefew',1,1,'Lista',0),(12,1,1,NULL,100,'nombre','Nombre','gghrttr3ewf455634',NULL,NULL,NULL,'fwewefew',1,2,'Lista',1),(13,1,1,NULL,100,'tabla','Tabla','weffewfef',NULL,NULL,NULL,'qwdwqd',1,3,'Lista',1),(14,1,1,NULL,100,'idMenu','Menu','wfweewht2',NULL,NULL,NULL,'ewfewfefew',1,4,'Lista',1),(15,1,1,NULL,100,'id',NULL,'regre',NULL,NULL,NULL,'wefwe',1,1,'Menu',0),(16,1,1,NULL,100,'nombre','Nombre','hytjyj',NULL,NULL,NULL,'jytjjtyjty',1,2,'Menu',1),(17,1,1,NULL,100,'url','Url','ergerg',NULL,NULL,NULL,'wefewf',1,3,'Menu',1),(18,1,1,NULL,100,'orden','Orden','jyt',NULL,NULL,NULL,'gewg',1,4,'Menu',1),(19,1,1,NULL,100,'tipo','Tipo','kuyk',NULL,NULL,NULL,'weg',1,5,'Menu',1),(20,1,1,NULL,100,'todos','Todos','kuykuy',NULL,NULL,NULL,'hthtrhtrh',1,6,'Menu',1),(21,1,1,NULL,0,'id',NULL,'qewdffewf',NULL,NULL,NULL,'wfew',1,1,'Usuario',0),(22,1,1,NULL,100,'nombre','Nombre','wefewfewg',NULL,NULL,NULL,'fwethtrhr',1,2,'Usuario',1);
...
INSERT INTO `columna_por_lista` VALUES (1,1),(2,1),(3,1),(4,1),(5,1),(6,6),(7,6),(8,6),(9,6),(10,6),(11,8),(12,8),(13,8),(14,8),(21,10),(22,10),(15,14),(16,14),(17,14),(18,14),(19,14),(20,14);
...
INSERT INTO `formulario` VALUES (16,'Formulario Parametro','Formulario Parametro');
...
INSERT INTO `lista` VALUES (2,'Parametro','Parametro',1),(5,'Perfil','Perfil',6),(7,'Lista','Lista',8),(9,'Usuario','Usuario',10),(11,'Fecha Evento','Fecha Evento',12),(13,'Menu','Menu',14);
...
INSERT INTO `lista_por_menu` VALUES (1,2);
...
INSERT INTO `menu` VALUES (1,NULL,'Parametro',0,'interno',0,'Parametro',2,15),(0,NULL,'Perfil',1,'interno',0,'Perfil',5,15),(0,NULL,'Lista',2,'interno',0,'Lista',7,15),(0,NULL,'Usuario',3,'interno',0,'Usuario',9,15),(0,NULL,'Fechas Evento',4,'interno',0,'Fechas Evento',11,15),(0,NULL,'Mantenimiento',0,'interno',0,'Mantenimiento',15,NULL);
...
INSERT INTO `parametro` VALUES (1,1,'ffewfewfwfew','dwqdwqd','A','1990-10-10','1990-10-10 00:00:00','validadar formularios','validar','--');
...
INSERT INTO `perfil` VALUES (1,1,'12312fwewe','qdqwdqwfqw234','A','1990-10-10','1990-10-10 00:00:00','administrador');
...
INSERT INTO `persona` VALUES (1,1,'admin',NULL,'63432','A','1990-10-10','1990-10-10 00:00:00','1990-10-10','admin',NULL);
...
INSERT INTO `recurso` VALUES (1,1,'Parametro','Lista Parametro','A','1990-10-10','1990-10-10 00:00:00'),(2,1,'Parametro','Menu Parametro','A','1990-10-10','1990-10-10 00:00:00'),(3,1,'Boton_Nuevo','Boton Nuevo','A','1990-10-10','1990-10-10 00:00:00'),(4,1,'Boton_Guardar','Boton Guardar','A','1990-10-10','1990-10-10 00:00:00'),(5,1,'Perfil','Menu Perfil','A','1990-10-10','1990-10-10 00:00:00'),(6,1,'Perfil','Lista Perfil','A','1990-10-10','1990-10-10 00:00:00'),(7,1,'Lista','Menu Lista','A','1990-10-10','1990-10-10 00:00:00'),(8,1,'Lista','Lista Lista','A','1990-10-10','1990-10-10 00:00:00'),(9,1,'Usuario','Menu Usuario','A','1990-10-10','1990-10-10 00:00:00'),(10,1,'Usuario','Lista Usuario','A','1990-10-10','1990-10-10 00:00:00'),(11,1,'FechaDiaEvento','Menu Fechas Evento','A','1990-10-10','1990-10-10 00:00:00'),(12,1,'FechaDiaEvento','Lista Fechas Evento','A','1990-10-10','1990-10-10 00:00:00'),(13,1,'Menu','Menu Menu','A','1990-10-10','1990-10-10 00:00:00'),(14,1,'Menu','Lista Menu','A','1990-10-10','1990-10-10 00:00:00'),(15,1,'Mantenimiento','Mantenimiento','A','1990-10-10','1990-10-10 00:00:00'),(16,1,'Formulario_Parametro','Formulario Parametro','A','1990-10-10','1990-10-10 00:00:00');
...
INSERT INTO `recurso_por_perfil` VALUES (NULL,1,1),(NULL,2,1),(NULL,3,1),(NULL,4,1),(NULL,5,1),(NULL,6,1),(NULL,7,1),(NULL,8,1),(NULL,9,1),(NULL,10,1),(NULL,11,1),(NULL,12,1),(NULL,13,1),(NULL,14,1),(NULL,15,1);
...
INSERT INTO `usuario` VALUES ('123456',1,'admin','123213','32131',1,1);
...
-- Dump completed on 2013-07-03  0:20:06
