...
CREATE TABLE `lista` (
  ...
  `id_recurso` int(11) NOT NULL,
  `rowClick` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id_recurso`),
...
INSERT INTO `lista` (`id_menu`,`nombre`,`tabla`,`id_recurso`,`rowClick`) VALUES 
 (2,'Parametro','Parametro',1,'Formulario_Parametro'),
 (5,'Perfil','Perfil',6,NULL),
 (7,'Lista','Lista',8,NULL),
 (9,'Usuario','Usuario',10,NULL),
 (11,'Fecha Evento','Fecha Evento',12,NULL),
 (13,'Menu','Menu',14,NULL);
