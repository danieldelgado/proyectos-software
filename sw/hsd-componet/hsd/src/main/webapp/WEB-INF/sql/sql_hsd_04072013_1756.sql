...
INSERT INTO `columna` (`id_columna`,`activo`,`addColumn`,`alineacion`,`ancho`,`atributo`,`cabecera`,`codigo`,`estado`,`fecha_actualizacion`,`fecha_registro`,`formato_tipo`,`mapping`,`orden`,`tabla`,`visible`,`onclick`) VALUES 
 (1,1,1,NULL,0,'id',NULL,'wefewfwf',NULL,NULL,NULL,'wefwe',1,1,'Parametro',0,NULL),
 (2,1,1,NULL,100,'codigo','Codigo','wefewf',NULL,NULL,NULL,'wefwefgeytjty',1,2,'Parametro',1,NULL),
 (3,1,1,NULL,100,'activo','Activo','gghrttr3ewf',NULL,NULL,NULL,'fwefweegweg',1,3,'Parametro',1,NULL),
 (4,1,1,NULL,100,'descripcion','Descripcion','gghrttr3ewf45',NULL,NULL,NULL,'wefew',1,4,'Parametro',1,NULL),
 (5,1,1,NULL,100,'valor','Valor','gghrttr3ewf455634',NULL,NULL,NULL,'fwewefew',1,5,'Parametro',1,NULL),
 (6,1,1,NULL,0,'id',NULL,'weffewfef',NULL,NULL,NULL,'qwdwqd',1,1,'Perfil',0,NULL),
 (7,1,1,NULL,100,'codigo','Codigo','wfweewht2',NULL,NULL,NULL,'ewfewfefew',1,2,'Perfil',1,NULL),
 (8,1,1,NULL,100,'descripcion','Descripcion','wefewfwf',NULL,NULL,NULL,'wefwe',1,3,'Perfil',1,NULL),
 (9,1,1,NULL,100,'estado','Estado','wefewf',NULL,NULL,NULL,'wefwefgeytjty',1,4,'Perfil',1,NULL),
 (10,1,1,NULL,100,'nombre','Nombre','gghrttr3ewf',NULL,NULL,NULL,'fwefweegweg',1,5,'Perfil',1,NULL),
 (11,1,1,NULL,0,'id',NULL,'fewwe',NULL,NULL,NULL,'wefew',1,1,'Lista',0,NULL),
 (12,1,1,NULL,100,'nombre','Nombre','gghrttr3ewf455634',NULL,NULL,NULL,'fwewefew',1,2,'Lista',1,NULL),
 (13,1,1,NULL,100,'tabla','Tabla','weffewfef',NULL,NULL,NULL,'qwdwqd',1,3,'Lista',1,NULL),
 (14,1,1,NULL,100,'idMenu','Menu','wfweewht2',NULL,NULL,NULL,'ewfewfefew',1,4,'Lista',1,NULL),
 (15,1,1,NULL,100,'id',NULL,'regre',NULL,NULL,NULL,'wefwe',1,1,'Menu',0,NULL),
 (16,1,1,NULL,100,'nombre','Nombre','hytjyj',NULL,NULL,NULL,'jytjjtyjty',1,2,'Menu',1,NULL),
 (17,1,1,NULL,100,'url','Url','ergerg',NULL,NULL,NULL,'wefewf',1,3,'Menu',1,NULL),
 (18,1,1,NULL,100,'orden','Orden','jyt',NULL,NULL,NULL,'gewg',1,4,'Menu',1,NULL),
 (19,1,1,NULL,100,'tipo','Tipo','kuyk',NULL,NULL,NULL,'weg',1,5,'Menu',1,NULL),
 (20,1,1,NULL,100,'todos','Todos','kuykuy',NULL,NULL,NULL,'hthtrhtrh',1,6,'Menu',1,NULL),
 (21,1,1,NULL,0,'id',NULL,'qewdffewf',NULL,NULL,NULL,'wfew',1,1,'Usuario',0,NULL),
 (22,1,1,NULL,100,'nombre','Nombre','wefewfewg',NULL,NULL,NULL,'fwethtrhr',1,2,'Usuario',1,NULL);
...
INSERT INTO `parametro` (`id_parametro`,`activo`,`codigo`,`descripcion`,`estado`,`fecha_actualizacion`,`fecha_registro`,`nombre`,`tipo`,`valor`) VALUES 
 ...
 (10,1,'codigo_formularios','Codigos Formularios','A','1990-10-10','1990-10-10 00:00:00','Codigo de Formularios','formulario',NULL);
...
INSERT INTO `persona` (`id_persona`,`activo`,`apellidos`,`celular`,`codigo`,`estado`,`fechaActualizacion`,`fecha_creacion`,`fecha_nacimiento`,`nombre`,`telefono_fijo`,`api_key`) VALUES 
 (1,1,'admin',NULL,'63432','A','1990-10-10','1990-10-10 00:00:00','1990-10-10','admin',NULL,NULL);
