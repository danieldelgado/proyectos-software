...
CREATE TABLE `boton_por_pagina` (
  ...
  PRIMARY KEY (`id_pagina`,`id_boton`),
  KEY `fk_boton_por_pagina_1_idx` (`id_pagina`),
  KEY `fk_boton_por_pagina_2_idx` (`id_boton`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `columna_por_lista` (
  ...
  PRIMARY KEY (`lista_id_recurso`,`columna_id_columna`),
...
CREATE TABLE `lista_por_pagina` (
  `lista_id_recurso` int(11) NOT NULL,
  `id_pagina` int(11) NOT NULL,
  PRIMARY KEY (`id_pagina`,`lista_id_recurso`),
  KEY `FKC943A907579CC787` (`id_pagina`),
  KEY `FKC943A9075204655F` (`lista_id_recurso`),
  CONSTRAINT `FKC943A907579CC787` FOREIGN KEY (`id_pagina`) REFERENCES `pagina` (`id_pagina`),
  CONSTRAINT `fk_lista_por_pagina_1` FOREIGN KEY (`lista_id_recurso`) REFERENCES `lista` (`id_recurso`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pagina` (
  ...
  KEY `fk_pagina_1_idx` (`id_menu_padre`),
  CONSTRAINT `fk_pagina_1` FOREIGN KEY (`id_menu_padre`) REFERENCES `menu` (`id_recurso`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pagina_2` FOREIGN KEY (`id_pagina`) REFERENCES `recurso` (`id_recurso`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-01-29  0:09:48
