...
public class PublisherMain {
	...
	public static void main(String ar[]) {
		ApplicationContext appContext = new ClassPathXmlApplicationContext(new String[] { "/META-INF/spring/publisher.xml" });
		...
		Publisher publisher = (Publisher) appContext.getBean("simpleMessageProducer");
		try {
