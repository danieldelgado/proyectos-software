...
public interface ChatService {
	...
	// public Conexion addUsuarioConectado(String connectionId, String origin,
	// Usuario usuario);
	// public boolean existeConexion(String connectionId);
	// public void removeUsuarioConectado(Usuario usuario);
	// public List<Usuario> listaConectados(Usuario usuario);//todos conectados
	// al chat menos yo
	...
	// public boolean addMensaje( Conexion conexion, Usuario usuariofrom,
	// Usuario to, String mensaje);
