...
<head>
    ...
    <link type="text/css" href="<c:url value="/resources/css/default.css" ></c:url>" rel="stylesheet" />
    ...
    <script type="text/javascript" src="<c:url value="/resources/js/wsclient.js"></c:url>"></script>
