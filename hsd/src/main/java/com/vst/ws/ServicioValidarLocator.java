...
public class ServicioValidarLocator extends org.apache.axis.client.Service implements com.vst.ws.ServicioValidar {

    public ServicioValidarLocator() {
    }


    public ServicioValidarLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public ServicioValidarLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for wsValidarEndPointPort
    private java.lang.String wsValidarEndPointPort_address = "http://localhost:9998/ServicioValidar";
    ...
    public com.vst.ws.WsValidarEndPoint getwsValidarEndPointPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.vst.ws.WsValidarEndPointPortBindingStub _stub = new com.vst.ws.WsValidarEndPointPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.vst.ws.WsValidarEndPoint.class.isAssignableFrom(serviceEndpointInterface)) {
                com.vst.ws.WsValidarEndPointPortBindingStub _stub = new com.vst.ws.WsValidarEndPointPortBindingStub(new java.net.URL(wsValidarEndPointPort_address), this);
                _stub.setPortName(getwsValidarEndPointPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.vst.com/", "ServicioValidar");
    }
